    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/autor/login").permitAll() // Permite acesso ao endpoint de login sem autenticação
                        .requestMatchers(HttpMethod.GET, "/auth").permitAll()// Permite acesso ao endpoint GET /auth sem autenticação
                        .requestMatchers(HttpMethod.POST, "/autor").permitAll() // Permite acesso ao endpoint POST /autor sem autenticação
                        .requestMatchers(HttpMethod.POST, "/obras").permitAll()// permite criar obra nova sem autenticação
                        .requestMatchers("/autor/**").authenticated() // Requer autenticação para qualquer endpoint que comece com /autor/
                        .requestMatchers("/obras/**").authenticated()// qualquer endpoint relacionado a obras precisa de autentcação
